                    ...
                    <a href="{{ url('/') }}" class="app-brand-link">
                        <span class="app-brand-logo demo">
                            <svg width="25" viewBox="0 0 25 42" version="1.1" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <path
                                    d="M13.0729 17.6837L5.793 7.3729C4.5709 5.274 1.0279 5.5906 0.9080 7.878V19.654C0.9080 20.354 1.3508 20.762 1.6385 20.856L10.3637 23.636C10.6698 23.738 10.9996 23.678 11.2355 23.472L22.9922 13.568C23.6842 12.978 23.1932 11.787 22.2854 11.834L13.8824 12.067C13.4182 12.08 12.9904 12.33 12.756 12.716L13.0729 17.6837Z"
                                    fill="#696cff"></path>
                            </svg>
                        </span>
                        <span class="app-brand-text demo menu-text fw-bolder ms-2">MyWallet</span>
                    </a>
